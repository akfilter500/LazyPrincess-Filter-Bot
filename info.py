...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "+hjI3IucdWT01ZTA1") #[ without @ ]
...
URL = "https://lazy-filter-bot-zidp.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://lazy-filter-bot-zidp.onrender.com".format(FQDN, PORT)
